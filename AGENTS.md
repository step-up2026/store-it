...
Store-It is a secure inventory management system for consumable products that lets storekeepers record usage and generate reorder lists, and purchasing officers track orders and deliveries.
...
- **Commit as your GitHub identity, or Vercel will block the deploy.** Vercel verifies that
  ...
  ```
  git config user.email "301968198+step-up2026@users.noreply.github.com"
  git config user.name "step-up2026"
  ```
